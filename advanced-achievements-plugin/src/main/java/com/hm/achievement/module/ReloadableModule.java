...
import com.hm.achievement.listener.statistics.AureliumSkillsListener;
...
public interface ReloadableModule {
	...
	@Binds
	@IntoSet
	Reloadable bindAureliumSkillsListener(AureliumSkillsListener aureliumSkillsListener);
